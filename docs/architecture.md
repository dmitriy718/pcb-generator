...
- `src/shared/assistant`: Offline prompt-to-parameter conversion and optional provider-intent boundary for editable assistant-generated designs.
...
structured representation. Complex Bezier logo path import remains a future SVG
importer extension.
